...
public class UserDbHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_QUERY =
            "CREATE TABLE "+ UserContract.NewUserInfo.TABLE_NAME+"" +
                    ...
                    + UserContract.NewUserInfo.ANTAL_VANDOR_5 +" TEXT);"; //Om ej fungerar flytta upp
    ...
    public void addInformations(String name, String power3, String power4,
                                ...
                                String vo2max_mliter_5,String antal_vandor_3,String antal_vandor_4,String antal_vandor_5, SQLiteDatabase db)
    {
