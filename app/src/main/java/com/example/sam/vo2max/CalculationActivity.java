...
public class CalculationActivity extends AppCompatActivity {
    ...
    private MediaPlayer fiveMinutesPassed, highBleep, buttonClickMenu,backButton;
    ...
    protected void onCreate(Bundle savedInstanceState) { // TODO behöver all metoder skrivas inom onCreate metoden?
        ...
        Button btnCalculate = (Button) findViewById(R.id.CalculateButtonID);
        ...
        btnStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                stopPlaying( highBleep);
                highBleep = MediaPlayer.create(CalculationActivity.this, R.raw.high_bleep_tone);
                highBleep.start();
            }
        });
        ...
        simpleChronometer.setOnChronometerTickListener(new Chronometer.OnChronometerTickListener() {
            ...
            public void onChronometerTick(Chronometer chronometer) {
                ...
                if ("05:00".equals(chronometer.getText())) {
                    ...
                    //stopPlaying(fiveMinutesPassed);
                    fiveMinutesPassed = MediaPlayer.create(CalculationActivity.this, R.raw.five_minutes_passed_voice);
                    fiveMinutesPassed.start();
                }
            }
        });
        ...
        btnCalculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                addUserInformation();
                buttonClickMenu = MediaPlayer.create(CalculationActivity.this, R.raw.button_click_menu2);
